          ...
          <div className="flex flex-col items-center justify-center lg:flex-row">
            <div className="lg:w-1/3 text-center lg:mb-8 mb-2">
              <img
                ...
                alt="Profile"
                className="rounded-full w-60 h-60 mx-auto mb-4"
              />
            </div>
            <div className="lg:w-2/3 lg:pl-8">
              <h1 className="text-4xl tracking-wide font-extrabold my-2 py-2 text-primary border-b border-zinc-600 text-center lg:text-left">{(userData?.fullName || user?.displayName) || 'Name'}</h1>
              <h2 className="text-xl lg:text-left text-center font-semibold text-main dark:text-white mb-4">About Me</h2>
              <p className="text-primary lg:text-left pr-0 lg:pr-24 text-center dark:text-gray-300 mb-4">
              ...
              <ul className="space-y-2 text-primary dark:text-gray-300">
                ...
                <li className="flex lg:justify-start text-center justify-center items-center pr-0">
