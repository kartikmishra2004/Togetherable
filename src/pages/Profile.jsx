            ...
            <ul className="space-y-2 text-primary dark:text-gray-300">
              ...
              <li>
                ...
                <div className="my-6 flex flex-col justify-center lg:items-start items-center">
                  ...
                  <button className="mt-4 lg:w-44 w-full bg-main text-white px-4 py-2 rounded-lg hover:bg-[#9036c8]">{completionPercentage === 100 ? 'Edit profile' : 'Complete profile'}</button>
                </div>
              </li>
            </ul>
          </div>
