          ...
          <div className="flex flex-col items-center justify-center lg:flex-row">
            <div className="lg:w-1/3 text-center lg:mb-8 mb-2">
              <img
                ...
                alt="Profile"
                className="rounded-full lg:w-60 lg:h-60 w-32 h-32 mx-auto mb-4"
              />
            </div>
            <div className="lg:w-2/3 lg:pl-8">
              ...
              <p className="text-primary lg:text-base text-sm lg:text-left pr-0 lg:pr-24 text-center dark:text-gray-300 mb-4">
              ...
              <ul className="space-y-2 text-primary dark:text-gray-300">
                <li className="flex lg:justify-start justify-center items-center lg:text-base text-sm">
                ...
                <li className="flex lg:justify-start text-center justify-center items-center pr-0 lg:text-base text-sm">
