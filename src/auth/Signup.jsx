...
const Signup = () => {
  ...
  if (user === null) {
    return (
      <div className="flex lg:h-[100vh] h-[90vh] pt-10 flex-col items-center justify-center font-main">
        <div className='flex flex-col items-center justify-center lg:border lg:border-zinc-800 lg:bg-secondary lg:p-14 p-4 rounded-lg'>
          ...
          <div className='w-full h-[1px] bg-zinc-500 my-6 lg:flex hidden justify-center items-center'><p className='bg-secondary px-2 text-xs'>OR</p></div>
          <div className="lg:flex hidden items-center w-full justify-center rounded-lg">
